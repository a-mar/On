...
\setsansfont{FiraSans-Light.otf}[Scale=MatchLowercase, Path=fonts/, BoldFont = FiraSans-Regular.otf, ItalicFont = FiraSans-LightItalic.otf, BoldItalicFont = FiraSans-Italic.otf]
\newfontfamily\ExtraLig{FiraSans-ExtraLight.otf}[Scale=MatchLowercase, Path=fonts/, ItalicFont = FiraSans-ExtraLightItalic.otf]
...
\newfontfamily\Book{FiraSans-Book.otf}[Scale=MatchLowercase, Path=fonts/, BoldFont = FiraSans-SemiBold.otf, ItalicFont = FiraSans-BookItalic.otf, BoldItalicFont = FiraSans-SemiBoldItalic.otf]
...
\titleformat{\chapter}[display]
  {\Medium\Huge\filcenter}{\chaptertitlename\ \thechapter}{-11pt}{\Huge}
