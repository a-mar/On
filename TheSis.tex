...
\usepackage[top=2.54truecm, bottom=3.26truecm, left=4truecm, right=2truecm, footskip=1.7truecm]{geometry}
...
%FIRA SANS VERSION
\setsansfont{FiraSans-ExtraLight.otf}[Scale=MatchLowercase, Path=fonts/, BoldFont = FiraSans-Book.otf, ItalicFont = FiraSans-ExtraLightItalic.otf, BoldItalicFont = FiraSans-BookItalic.otf]
\newfontfamily\Light{FiraSans-Light.otf}[Scale=MatchLowercase, Path=fonts/, ItalicFont = FiraSans-LightItalic.otf]
\newfontfamily\UltraLig{FiraSans-UltraLight.otf}[Scale=MatchLowercase, Path=fonts/, ItalicFont = FiraSans-UltraLightItalic.otf]
\newfontfamily\Medium{FiraSans-Medium.otf}[Scale=MatchLowercase, Path=fonts/, ItalicFont = FiraSans-MediumItalic.otf]
\newfontfamily\Book{FiraSans-Regular.otf}[Scale=MatchLowercase, Path=fonts/, BoldFont = FiraSans-SemiBold.otf, ItalicFont = FiraSans-Italic.otf, BoldItalicFont = FiraSans-SemiBoldItalic.otf]
...
%\makeatletter
%\def\url@foostyle{%
%  \@ifundefined{selectfont}{\def\UrlFont{\sf}}{\def\UrlFont{\sloppy\normalfont\bfseries}}}
%\makeatother
...
\titleformat{\chapter}[display]
  {\Book\bfseries\Huge\filcenter}{\chaptertitlename\ \thechapter}{-11pt}{\Huge}
\titleformat{\section}{\Medium\huge}{\thesection}{0.9em}{}
\titleformat{\subsection}{\Medium\LARGE}{\thesubsection}{0.9em}{}

\titlespacing*{\chapter}{0pt}{-44pt}{18pt}
\titlespacing*{\section}{0pt}{13pt}{9pt}
\titlespacing*{\subsection}{0pt}{10pt}{9pt}
\titleformat{\subparagraph}{\Medium\Large}{\thesubparagraph}{1em}{}
...
\addto\captionsenglish{\renewcommand{\glossyname}{\Book\bfseries\Huge\centering\vspace*{11pt}Abbreviations\vspace{5pt}}}
\newcommand*{\ackname}{Acknowledgements}
\addto\captionsenglish{\renewcommand{\ackname}{\Book\bfseries\Huge\centering\vspace*{-31pt}Acknowledgements\vspace{5pt}}}
...
\hypersetup{
    colorlinks,
    linkcolor={cwcSalmon!45!},	%CHANGE TO BLACK WHEN DONE
    citecolor={cwcGreen1!45!},	%CHANGE TO BLACK WHEN DONE
    urlcolor={redd!60!cwcSalmon85},
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{colores.tex}		%de colores
\input{cyclo.tex}		%colour cycles
\input{diagramme.tex}	%plot styles
\input{comando.tex}		%macros
